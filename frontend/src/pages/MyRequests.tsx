    ...
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <div className="card text-center py-12">
          ...
          <Link to="/request" className="btn-primary mt-4 inline-block">
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-100">
                <th className="text-left px-6 py-3 text-xs font-semibold text-brand-gray uppercase tracking-wide">
                  Zeitraum
                </th>
                <th className="text-left px-6 py-3 text-xs font-semibold text-brand-gray uppercase tracking-wide">
                  Tage
            ...
            <tbody className="divide-y divide-gray-50">
              {requests.map((r) => (
                <tr key={r.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-brand-gray max-w-xs truncate">
                    {r.reason || '—'}
                  </td>
